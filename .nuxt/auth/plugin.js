...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"auth/login","method":"post","propertyName":"result.accessToken"},"logout":false,"user":{"url":"auth/profile","method":"get","propertyName":"result"}},"_name":"local"}))
